...
if options.plotfile:
    ...
    canvas = ROOT.TCanvas("asdf", "asdf", 800, 1200)
    ...
    canvas_nuis = ROOT.TCanvas("nuisances", "nuisances", 900, 1200)
    ...
    canvas_pferrs = ROOT.TCanvas("post_fit_errs", "post_fit_errs", 900, 1200)
