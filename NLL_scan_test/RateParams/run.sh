...
for YEAR in ${YEARS[@]};do
    ...
    POIRANGE="Wjetsnorm_Boosted_GGF0_${YEAR}=0.2,2.0:Wjetsnorm_Boosted_GGF1_${YEAR}=0.2,2.0:Wjetsnorm_Boosted_VBF_${YEAR}=0.2,2.0:Wjetsnorm_Resolved_GGF0_${YEAR}=0.2,2.0:Wjetsnorm_Resolved_GGF1_${YEAR}=0.2,2.0:Wjetsnorm_Resolved_VBF_${YEAR}=0.2,2.0:topnorm_Boosted_GGF0_${YEAR}=0.2,2.0:topnorm_Boosted_GGF1_${YEAR}=0.2,2.0:topnorm_Boosted_VBF_${YEAR}=0.2,2.0:topnorm_Resolved_GGF0_${YEAR}=0.2,2.0:topnorm_Resolved_GGF1_${YEAR}=0.2,2.0:topnorm_Resolved_VBF_${YEAR}=0.2,2.0"
